...
# Two models are available: BERT for short text and the Longformer for long text
...
class AutoModelWithTabular:
    ...
    def from_config(cls, config):
        ...
        Note:
            Only the models in implementations.py are implemented

        Args:
            config (:class:`~transformers.PretrainedConfig`):
                The model class to instantiate is selected based on the configuration class:
                    see implementations.py for supported transformer models
